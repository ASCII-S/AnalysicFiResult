...
def set_prog():
	...
	if progname == "amg":					## amg
		...
		progbin = "/home/tongsy/programs/rodinia-master/openmp/backprop/backprop"
		optionlist = ['65536']
		...
		progbin = "/home/tongsy/programs/rodinia-master/openmp/bfs/bfs"
		datafile = "/home/tongsy/programs/rodinia-master/data/bfs/inputGen/graph64k.txt"
		optionlist = [datafile]
        ...
        elif progname == "myocyte":                             ## myocyte
		progbin = "/home/tongsy/programs/rodinia-master/openmp/myocyte/myocyte"
		optionlist = ['100', '1', '0', '4']
	elif progname == "srad":
		progbin = "/home/tongsy/programs/rodinia-master/openmp/srad_v1/srad"
		...
		progbin = "/home/tongsy/programs/ANL/XSBench/openmp-threading/XSBench"
